  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-12 mt-20">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed">
            Nơi mang đến niềm vui và trí tuệ cho bé yêu qua từng món đồ chơi chất lượng cao, an toàn và bổ ích.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex items-center gap-2">
              <span>📍</span> 123 Đường ABC, Quận 1, TP.HCM
            </li>
            <li className="flex items-center gap-2">
              <span>📞</span> 0909 123 456
            </li>
            <li className="flex items-center gap-2">
              <span>✉️</span> hotro@toystore.vn
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-500">
        © 2024 ToyStore. All rights reserved. Designed by You.
      </div>
    </footer>
  );
}